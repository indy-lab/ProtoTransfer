...
def parse_args(script):
    ...
    parser.add_argument('--train_n_shot' , default=5, type=int,  help='shot num per class to classify for training') #baseline and baseline++ would ignore this parameter
